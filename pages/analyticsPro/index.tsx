    ...
    datasets: [
      {
        ...
        data:
          planId !== 1
            ...
            : [5, 2, 7, 6, 9],
        backgroundColor: ["blue", "green", "red", "yellow", "violet"],
        borderColor: ["blue", "green", "red", "yellow", "violet"],
        borderWidth: 1,
      },
    ],
  };
                ...
                <div className={styles.filterByDevice}>
                  ...
                  <div>
                    <Form.Select
                      ...
                      style={{ border: "2px solid #af38d6", width: "150px" }}
                      ...
                      <div className={styles.analytics_tapBox}>
                        ...
                        <div>
                          <Form.Select
                            placeholder="Font Size"
                            className={styles.timeRange}
                            style={{ borderColor: "white", fontSize: "12px" }}
