...
import profileImage from "../../images/Phase_2_All_Assets/comman_assets/profile.svg";
...
function EditUserProfilePage() {
  ...
  const rightPositions = [0, -19, 0];
  const leftPosition = [-22, 0, -9];
                  ...
                  >
                    ...
                    >
                      ...
                      <DatePicker
                        ...
                        yearDropdownItemNumber={25} // Adjust as needed
