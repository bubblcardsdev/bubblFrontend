...
function BundleDevice() {
  ...
  const dummyText = [
    {
      main: "Bubbl Bundle: NFC-based digital networking solution",
    },
    {
      main: "E-business card, socket, bundle",
    },
  ...
  const individuals: any = devices ? devices["Bundle Devices"] : null;

  let colors: any = [];
  if (individuals) {
    colors = Object.keys(individuals?.images);
  }
    ...
    if (cartArray.length === 0) {
      const newCartArray = [
        ...cartItems,
        {
          ...
          productImage:
            individuals?.images[selectColor] || individuals?.images[colors[0]],
          productType: individuals?.type,
          quantity: itemCount,
          productColor: selectColor || colors[0],
          productPrice: individuals?.price * itemCount,
          itemPrice: individuals?.price,
      ...
      const existingProduct = cartArray.find(
        (cartItem: any) =>
          ...
          cartItem.productType === individuals?.type
      );
      ...
      if (existingProduct === undefined) {
        const newCartInExisting = [
          ...cartArray,
          {
            ...
            productImage:
              individuals?.images[selectColor] ||
              individuals?.images[colors[0]],
            productType: individuals?.type,
            quantity: itemCount,
            productColor: selectColor || colors[0],
            productPrice: individuals?.price * itemCount,
          ...
          <Container>
            ...
            <Row className={styles.ImageRowDiv}>
              <Col className={styles.imageColResponsive}>
                <div className={styles.imageBackGround}>
                  {selectColor !== undefined ? (
                    <Image
                      src={individuals?.images[selectColor]}
                      width={500}
                      height={500}
                      alt="bubbl"
                    />
                    ...
                    <Image
                      src={individuals?.images[colors[0]]}
                      width={500}
                      height={500}
                      alt="bubbl"
                    />
              ...
              <Col>
                ...
                <hr className={styles.hrTagResponsiveAboutItem} />
                <div className={styles.aboutItemDiv}>
                  <h2>About this item</h2>
                  <p style={{ marginTop: "25px" }}>
                    Introducing the Bubbl Bundle – a cutting-edge NFC-based
