...
import profileImg from "../../images/Phase_2_All_Assets/comman_assets/profile.svg";
            ...
            <div className={styles.shippingHeading}>
              ...
              <div className={styles.edit_data}>
                <div className={`${styles["avatar-wrapper"]}`}>
                  {userProfileData?.userProfile?.userImage ? (
                    <Image
