...
function ProductListTile() {
  ...
  const dummyText = [
    {
      main: "Bubbl Tile: NFC-based digital networking solution",
    },
    {
      main: "E-business tile",
    },
  ...
  const getShopDetails = async () => {
    ...
    const individual = shopItems ? [shopItems.Tile] : [];
  ...
  const individuals: any = devices ? [devices.Tile] : [];
              ...
              <Col>
                ...
                <div className={styles.aboutItemDiv}>
                  ...
                  <p style={{ marginTop: "25px" }}>
                    Introducing the Bubbl Tile – a cutting-edge NFC-based
