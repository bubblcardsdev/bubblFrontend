...
function Footer() {
  ...
  return (
    <section className={styles.footer_section}>
      ...
      >
        <Modal.Header className={styles.ModalBg}>
          <Modal.Title className={styles.head}>
            Returns & Refunds Policy
          </Modal.Title>
          <div
            className={styles.customArrow}
            onClick={() => setLgShowsRefund(false)}
          >
            &#x2715;
          </div>
        </Modal.Header>
      ...
      >
        <Modal.Header className={styles.ModalBg}>
          ...
          <div className={styles.customArrow} onClick={() => setLgShow(false)}>
            &#x2715;
          </div>
        </Modal.Header>
        <Modal.Body className={styles.ModalBg}>
      ...
      >
        <Modal.Header className={styles.ModalBg}>
          <Modal.Title className={styles.head}>TERMS OF USE</Modal.Title>
          <div
            className={styles.customArrow}
            onClick={() => setLgShowsTerms(false)}
          >
            &#x2715;
          </div>
        </Modal.Header>
      ...
      <div className={styles.footer_details}>
        <div className={styles.logo_icon} onClick={() => router.push("/")}>
          <Image src={NavLogo} alt="Logo" width={98} height={24} />
        </div>
        <div className={styles.footer_links}>
          <div className={styles.customerCare}>
            <h2>Customer Care</h2>
            <Link href="tel:+917358108634">+91 7358108634 </Link>
            <Link href="tel:+917845861552">+91 7845861552 </Link>
          </div>
          <div className={styles.resp_footer}>
            <div className={styles.customerCareResp}>
              <h2>Customer Care</h2>
              <Link href="tel:+917358108634">+91 7358108634 </Link>
              <br />
              <Link href="tel:+917845861552">+91 7845861552 </Link>
            </div>
            <div className={styles.contactInformationResp}>
              <h2>Contact Information</h2>
              <div className={styles.contact_info_resp}>
                <Link href="mailto:support@bubbl.cards">
                  support@bubbl.cards
                </Link>
              </div>
            </div>
          ...
          <div className={styles.quickLinks}>
            ...
            <div className={styles.linkPage}>
              ...
              <Link href="/BubblAnalytics">Analytics</Link>
          ...
          <div className={styles.contactInformation}>
            <h2>Contact Information</h2>
            <div className={styles.contact_info_resp}>
              <Link href="mailto:support@bubbl.cards">support@bubbl.cards</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.copyrights}>
        <p>Bubbl 2024. All rights reserved</p>
        <p>Powered By: XPULSAR TECHNOLOGIES PVT. LTD</p>
        <div className={styles.BottomLink}>
          <h6 onClick={() => setLgShowsRefund(true)}>Refund Policy</h6>
          <h6 onClick={() => setLgShow(true)}>Privacy Policy</h6>
          <h6 onClick={() => setLgShowsTerms(true)}>Terms & Conditions</h6>
        </div>
      </div>
    </section>
  );
