...
const LocationSVG: React.FC<LocationSVGProps> = ({ color }) => (
  <svg
    ...
    height={23}
    viewBox="0 0 18 24"
    // style="enable-background:new 0 0 18 24;"
    xmlSpace="preserve"
  >
    <style type="text/css">
      {`.st0 {
    ...
    <path
      className="st0"
      d="M8.4,23.6c-0.4-0.1-0.7-0.4-0.9-0.8c-1.9-2.8-3.7-5.7-5.6-8.5c-0.8-1.2-1.4-2.5-1.7-4C0,9.1,0.1,7.9,0.4,6.7
   ...
   c0.6-1,1-2.2,1.1-3.3c0.1-1.6-0.2-3.1-1.1-4.5C13.5,2.8,11.3,1.7,8.6,1.6z"
    ...
    <path
      className="st0"
      d="M8.6,13.6c-2.5,0-4.5-2-4.5-4.5c0-2.5,2-4.5,4.5-4.5c2.5,0,4.5,2,4.5,4.5C13.1,11.6,11.1,13.6,8.6,13.6z
