...
import styles from "./socketList.module.css";
...
function ProductListSocket() {
  ...
  const dummyText = [
    {
      main: "Bubbl Socket: NFC-based digital networking solution",
    },
    {
      main: "E-business socket",
    },
  ...
  const getShopDetails = async () => {
    ...
    const individual = shopItems ? [shopItems.Socket] : [];
  ...
  const individuals: any = devices ? [devices.Socket] : [];
              ...
              <Col>
                <div className={styles.colBack}>
                  ...
                  <Row className={styles.quantityPriceDiv}>
                    ...
                    <Col className={styles.customization_details_right}>
                      ...
                      <h4>
                        Rs.{individuals[0]?.price} &nbsp;
                        <span> Per socket</span>
                      </h4>
                    </Col>
                  </Row>
                  {/* Add to Cart Button */}
                ...
                <div className={styles.aboutItemDiv}>
                  ...
                  <p style={{ marginTop: "25px" }}>
                    Introducing the Bubbl Socket – a cutting-edge NFC-based
